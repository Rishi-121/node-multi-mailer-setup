...
multiMailer.configuration({
  senderEmail: "info@webmandi.co.in",
  senderName: "Webizy IT Solutions",
  sendGridApiKay: process.env.SENDGRID_API_KEY,
  replyTo: "18cse060.hrushikeshdas@giet.edu", /// else default will be no-reply@webizysolutions.com
...
app.get("/", async (req, res, next) => {
  await multiMailer.sendTextEmail(
    "developer.shiv2020@gmail.com",
    " my subject testing ",
